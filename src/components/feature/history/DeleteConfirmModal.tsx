    ...
    <div className="flex w-[327px] flex-col items-center gap-3 overflow-hidden rounded-[20px] bg-white py-5">
      ...
      <div className="flex w-full items-center gap-2 px-5">
        <button
          onClick={onClose}
          disabled={isPending}
          className="flex h-12 flex-1 items-center justify-center rounded-xl bg-gray-200 px-10 py-2.5 disabled:opacity-50"
        >
        ...
        <button
          onClick={onConfirm}
          disabled={isPending}
          className="flex h-12 flex-1 items-center justify-center rounded-xl bg-[#57534e] px-10 py-2.5 disabled:opacity-50"
        >
